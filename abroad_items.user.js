...
(function() {
    ...
    function changeHeader() {
        let header = document.querySelector(".table_heading_row").children;
        console.log(header);
    }
    ...
    function createTable() {
        ...
        if (typeof data == "undefined" || data == null) {
            ...
            if (length1 > 0 || length2 > 0) {
                ...
                let table_html1 = '<table id="hardy_table"><tr class="table_heading_row"><th class="hardy_travel_sortable_header" id="hardy_header_destination_0">Destination <p class="hidden_stamps">bitch</p>&#x25B2;&#x25BC;</th><th>Item</th><th class="hardy_travel_sortable_header" id="hardy_header_item_2">Item Name <p class="hidden_stamps">bitch</p>&#x25B2;</th><th class="hardy_travel_sortable_header" id="hardy_header_quantity_3">Item Quantity <p class="hidden_stamps">bitch</p>&#x25B2;</th><th class="hardy_travel_sortable_header" id="hardy_header_price_4">Item Price <p class="hidden_stamps">bitch</p>&#x25B2;</th><th class="hardy_travel_sortable_header" id="hardy_header_type_5">Item Type <p class="hidden_stamps">bitch</p>&#x25B2;</th><th class="hardy_travel_sortable_header" id="hardy_header_stamp_6">Last Updated <p class="hidden_stamps">bitch</p>&#x25B2;</th></tr><tbody id="hardy_tbody">';
                if (array2.length > 0) {
                    ...
                    sortTable("hardy_header_price_4");
                } else {
